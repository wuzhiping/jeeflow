...
export declare const JeeflowUiKey: unique symbol;
/** 选人场景：办理候选走引擎；其余走宿主 listUsers */
export type JeeflowUserPickerScene = 'candidate' | 'nextOperator' | 'cc' | 'surrogate' | 'assignee';
...
export declare function resolveAdapters(config: {
