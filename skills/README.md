...
- **v1.51** · 2026-11-17 · **同步 v22-v29 SPI 路由能力到 docs/ + skills/** · 4 份 docs 更新 (api.md §1.5 SPI 路由 + architecture.md §4.4 三层 dispatcher + integration.md §5.4/§5.5 SPI_FOLDER + main_common + AGENTS.md 约束 #33 SPI 路由必须 dispatcher) · 4 份 skills 更新 (SKILL-TREE.md §16 SPI dispatcher 章节 + SKILLS.md SPI 能力描述 + RML.md SPI 章节 + README.md v1.51) · 8 份 v22-v29 retrospective 已索引 · 数据层 100% 不动 (spi/dev/data.py 40020 bytes, 22 DictProxy + 2 helpers + verify() 保留)
