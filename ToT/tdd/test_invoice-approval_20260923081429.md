# TDD Test Log · invoice-approval · 20260923081429
...
### small path (instance=92285408950273) — variable=`{"amount": 500, "purpose": "办公"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
...
### big path (instance=92285408959492) — variable=`{"amount": 8000, "purpose": "服务器"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
...
### reject path (instance=92285408973832) — variable=`{"amount": 8000, "purpose": "服务器"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
