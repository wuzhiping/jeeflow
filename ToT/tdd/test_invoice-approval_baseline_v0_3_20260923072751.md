# Baseline · invoice-approval · v0.3 · 20260923072751

> **目的**：流程自动化生成的 baseline（用 `tdd-flow.py --save-baseline`）
> **原始测试**：`ToT/tdd/test_invoice-approval_20260923072751.md`
> **原始数据**：`ToT/tdd/test_invoice-approval_baseline_v0_3_20260923072751.json`

---

# TDD Test Log · invoice-approval · 20260923072751
...
### small path (instance=92282544481281) — variable=`{"amount": 500, "purpose": "办公"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
...
### big path (instance=92282544491524) — variable=`{"amount": 8000, "purpose": "服务器"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
...
### reject path (instance=92282544504840) — variable=`{"amount": 8000, "purpose": "服务器"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
