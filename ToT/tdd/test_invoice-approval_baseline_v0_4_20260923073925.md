# Baseline · invoice-approval · v0.4 · 20260923073925

> **目的**：流程自动化生成的 baseline（用 `tdd-flow.py --save-baseline`）
> **原始测试**：`ToT/tdd/test_invoice-approval_20260923073925.md`
> **原始数据**：`ToT/tdd/test_invoice-approval_baseline_v0_4_20260923073925.json`

---

# TDD Test Log · invoice-approval · 20260923073925
...
### small path (instance=92283255219201) — variable=`{"amount": 500, "purpose": "办公"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
...
### big path (instance=92283255229444) — variable=`{"amount": 8000, "purpose": "服务器"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
...
### reject path (instance=92283255243784) — variable=`{"amount": 8000, "purpose": "服务器"}` — top_vars=`{"tf_manager": "u_bob", "tf_treasurer": "u_carol"}`
