# Baseline · fdep · v0.2 · 20260923074600

> **目的**：流程自动化生成的 baseline（用 `tdd-flow.py --save-baseline`）
> **原始测试**：`ToT/tdd/test_fdep_20260923074600.md`
> **原始数据**：`ToT/tdd/test_fdep_baseline_v0_2_20260923074600.json`
...
### happy path (instance=92283658836993)
...
### reject path (instance=92283658868744)
...
### resurrect path (instance=92283658877963)
