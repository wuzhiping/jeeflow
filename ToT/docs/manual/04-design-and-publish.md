...
>
> **本仓实测**：基于 `vendor/jeeflow/facade.py` 60+ action 中的 `processDesign/*`（10 个）+ `processDefine/*`（9 个）+ 节点 properties 21 字段（spec/02）。
>
...
> **本仓实测**（`vendor/jeeflow/docs/flow.md §3.3` 任务节点 properties 21 字段）：
>
