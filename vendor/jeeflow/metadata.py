...
BUILTIN_ASSIGNMENT_METAS: list[HandlerMeta] = [
    ...
    HandlerMeta(type="AssignmentHandler",
                className="com.mldong.jeeflow.interceptor.impl.ApplicantDeptLeaderAssignmentHandler",
                displayName="发起人所属部门经理", order=10),
    HandlerMeta(type="AssignmentHandler",
                className="com.mldong.jeeflow.interceptor.impl.ApplicantDeptMainLeaderAssignmentHandler",
                displayName="发起人所属部门分管领导", order=20),
    HandlerMeta(type="AssignmentHandler",
                className="com.mldong.jeeflow.interceptor.impl.DeptLeaderAssignmentHandler",
                displayName="当前用户所属部门经理", order=30),
    HandlerMeta(type="AssignmentHandler",
                className="com.mldong.jeeflow.interceptor.impl.DeptMainLeaderAssignmentHandler",
    ...
    HandlerMeta(type="AssignmentHandler",
                className="com.mldong.jeeflow.interceptor.impl.TaskRoleAssigneeHandler",
